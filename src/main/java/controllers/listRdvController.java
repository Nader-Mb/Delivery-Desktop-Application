...
public class listRdvController implements Initializable {
    ...
    @FXML
    private AnchorPane listRdvPane;
        ...
        try {
            ...
            for(int i=0;i<rdvs.size();i++) {
                ...
                try {
                    ...
                    itemController.setData(rdvs.get(i));
    ...
    void genererPDF(MouseEvent event) {
        ...
        if (selectedFile != null) {
            ...
            RdvService as = new RdvService();
            List<Rdv> rdvList = as.Show();
            ...
            try {
                ...
                Paragraph title = new Paragraph("Liste des Rendez-vous", font);
                ...
                PdfPCell cell2 = new PdfPCell(new Paragraph("Prenom", hrFont));
                ...
                PdfPCell cell3 = new PdfPCell(new Paragraph("Numero Tel", hrFont));
                ...
                PdfPCell cell4 = new PdfPCell(new Paragraph("Email", hrFont));
                ...
                PdfPCell cell5 = new PdfPCell(new Paragraph("Date", hrFont));
                ...
                for (Rdv act : rdvList) {
                    ...
                    PdfPCell cellR3 = new PdfPCell(new Paragraph(String.valueOf(act.getNumTel()), hdFont));
                    ...
                    PdfPCell cellR4 = new PdfPCell(new Paragraph(String.valueOf(act.getEmail()), hdFont));
                    ...
                    PdfPCell cellR5 = new PdfPCell(
                            new Paragraph(String.valueOf(act.getDateRdv()), hdFont));
