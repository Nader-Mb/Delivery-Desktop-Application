...
public class ListUserController implements Initializable {
    ...
    @FXML
    private TableColumn<User, Integer> numberUser;
    ...
    @FXML
    private TableColumn<User, Double> ratingUser;
    ...
    private final String[] attributsSearch = {"firstName", "lastName", "Email", "Address", "Role"};
    private final String[] attributsSort = {"First Name", "lastName", "Email", "Address", "Role"};
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            numberUser.setCellValueFactory(new PropertyValueFactory<>("Number"));
            lNameUser.setCellValueFactory(new PropertyValueFactory<>("LastName"));
            fNameUser.setCellValueFactory(new PropertyValueFactory<>("FirstName"));
            addressUser.setCellValueFactory(new PropertyValueFactory<>("Address"));
            roleUser.setCellValueFactory(new PropertyValueFactory<>("Role"));
            ratingUser.setCellValueFactory(new PropertyValueFactory<>("Rating"));
            addButtonsToTable();
   ...
   public void initialize() {
    ...
    private void export(ActionEvent event) {
        ExcelExporterUser d = new ExcelExporterUser();
    ...
    private void showStatistics(ActionEvent event) {
        try {
            ...
            DashboardControllerUsers dashboardController = loader.getController();
                ...
                return new TableCell<User, Void>() {
...

                    {
                        ...
                        supprimerButton.setOnAction((ActionEvent event) -> {
                            ...
                            A.setContentText("Voulez vous supprimer\nL'utilisateur  : " + user.getFirstName() +" "+user.getLastName()+", avec l'email : "+ user.getEmail()+" ?");
                            ...
                            try {
                                ...
                                alert.setContentText("user "+user.getFirstName()+" "+user.getLastName()+" has been deleted successfully");
                                alert.showAndWait();
                            }
                            catch (SQLException e){
                                Alert alert = new Alert(Alert.AlertType.ERROR);
    ...
    private void sortData() {
        ...
        if (selectedSortOption != null) {
            ...
            switch (selectedSortOption) {
                case "First Name":
                    fNameUser.setSortType(TableColumn.SortType.ASCENDING);
                    tableView.getSortOrder().setAll(fNameUser);
                    break;
               case "lastName":
                    lNameUser.setSortType(TableColumn.SortType.ASCENDING);
                    tableView.getSortOrder().setAll(lNameUser);
                    break;
               case "Email":
                    ...
                    break;
                case "Address":
                    addressUser.setSortType(TableColumn.SortType.ASCENDING);
                    tableView.getSortOrder().setAll(addressUser);
                    break;
                case "Role":
